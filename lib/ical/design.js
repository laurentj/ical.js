...
ICAL.design = (function() {
  ...
  var design = {
    ...
    property: {
      ...
      "anniversary": { defaultType: "date", allowedTypes: ["date-time", "date", "text"] },
      "bday":{ defaultType: "date", allowedTypes: ["date-time", "date", "text"] },
      ...
      "key" : { defaultType: "uri", allowedTypes: ["uri", "text"]  },
      "lang": DEFAULT_TYPE_TEXT,
      "logo": DEFAULT_TYPE_URI,
      "member": DEFAULT_TYPE_URI,
      "n":DEFAULT_TYPE_TEXT_STRUCTURED,
      "nickname": DEFAULT_TYPE_TEXT_MULTI,
      "note": DEFAULT_TYPE_TEXT,
      "org": DEFAULT_TYPE_TEXT_STRUCTURED,
      "photo": DEFAULT_TYPE_URI,
      "related": DEFAULT_TYPE_URI,
      "rev": DEFAULT_TYPE_TEXT, // timestamp
      "role": DEFAULT_TYPE_TEXT,
      "sound": DEFAULT_TYPE_URI,
      "tel":{ defaultType: "uri", allowedTypes: ["uri", "text"]  },
      "title": DEFAULT_TYPE_TEXT,
      "tz": { defaultType: "text", allowedTypes: ["uri", "text"]  },
    },
